<template>
  <div class="container page-content">
    ...
    <form-check-field label="만 14세 이상입니다 (필수)" v-model:checked="terms.over14" />
    <form-check-field label="서비스 기본 약관 (필수)" v-model:checked="terms.service">
...
export default defineComponent({
  ...
  setup() {
    ...
    const terms = reactive({ over14: false, service: false, marketing: false });
    ...
    const checkedRequired = computed(() => terms.over14 && terms.service);
