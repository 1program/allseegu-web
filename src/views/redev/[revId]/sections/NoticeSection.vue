<template>
  <div class="section">
    ...
    <div class="section-content">
      <ListTile badge="공지" title="신림동 대위원회 회의 결과 발표" />
      <ListDivider />
      <ListTile title="새해 복 많이 받으세요!" />
      <ListDivider />
      <ListTile title="한결같은 마음으로 결실을 위해 최선을 다하는..." />
    </div>
  </div>
  <MoreButton>공지사항 더보기</MoreButton>
</template>
...
export default defineComponent({
  name: "NoticeSection",
  components: { ListTile, ListDivider, MoreButton },
});
</script>
