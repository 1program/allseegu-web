...
export class RedevPolygon extends naver.maps.Polygon {
  constructor(redev: RedevGeometry, map: naver.maps.Map) {
    super({
      map,
      fillColor: redevMapColors.blue,
      fillOpacity: RedevPolygon.getOpacity(map.getZoom()),
      strokeWeight: 0,
    ...
    map.addListener("zoom_changed", () => {
      ...
      this.setOptions("fillOpacity", RedevPolygon.getOpacity(zoom));
    });
  }
